          ...
          if (chat.welcome) {
            ...
            for (let user of participants) {
              ...
              try {
                ...
                let wel = `https://api.ichikaa.xyz/api/welcome?name=${encodeURIComponent(this.getName(user))}&descriminator=${user.split(`@`)[0].substr(-5)}&totalmem=${encodeURIComponent(groupMetadata.participants.length)}&namegb=${encodeURIComponent(this.getName(jid))}&ppuser=${pp}&background=https://telegra.ph/file/1dfe7720d51f20e4c5f0c.jpg&mem=50&gcname=Wibu%20Nolep`
                let lea = `https://api.ichikaa.xyz/api/goodbye?name=${encodeURIComponent(this.getName(user))}&descriminator=${user.split(`@`)[0].substr(-5)}&totalmem=${encodeURIComponent(groupMetadata.participants.length)}&namegb= ${encodeURIComponent(this.getName(jid))}&ppuser=${pp}&background=https://telegra.ph/file/1dfe7720d51f20e4c5f0c.jpg&mem=50&gcname=Wibu%20Nolep`
